<template xmlns:v-bind="http://www.w3.org/1999/xhtml">
    <div id="physical-development" class="view">

        <div style="font-size: 24px; font-weight: bold; margin-bottom: 20px;">{{ msg.physical_development.full_name }}</div>
...
<script src="./physical.development.module.js"></script>
