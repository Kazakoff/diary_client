...
<style>
    *, *::after, *::before {
    ...
    .settings-drop a:hover { text-decoration: none; border-left: 3px solid #4d759a; }
    ...
    .left-sidebar a:hover { text-decoration: none; border-left: 3px solid #4d759a; }
